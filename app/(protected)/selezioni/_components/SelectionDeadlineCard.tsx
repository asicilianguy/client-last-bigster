        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <div className="flex items-center gap-2 justify-end mb-1">
              <UrgencyIcon className="h-5 w-5" style={{ color: colors.icon }} />
              <span
      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          <div className="flex items-center justify-between mt-1">
            <span className="text-xs text-bigster-text-muted">Inizio</span>
            <span className="text-xs text-bigster-text-muted">33%</span>
            <span className="text-xs text-bigster-text-muted">66%</span>
            <span className="text-xs text-bigster-text-muted">Scadenza</span>
          </div>
        </div>
          ...
          <div
            ...
            style={{
              backgroundColor: deadlineInfo.isOverdue
                ? `${colors.bg}80`
                : "#f5f5f7",
              borderColor: deadlineInfo.isOverdue ? colors.border : "#d8d8d8",
            }}
          >
            <p
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-bigster-text-muted leading-relaxed">
                Per rispettare le tempistiche previste, è consigliato cambiare
                lo stato della selezione in{" "}
        ...
        <div className="pt-4 border-t border-bigster-border">
          <p className="text-xs text-bigster-text-muted leading-relaxed">
            <span className="font-semibold">Nota:</span> Queste scadenze sono
            indicative e non bloccano le operazioni. Servono come guida per
            mantenere un flusso di lavoro efficiente e tempestivo. È sempre
            possibile cambiare lo stato della selezione indipendentemente dalle
            tempistiche.
          </p>
        </div>
      </div>
