          ...
          <div className="space-y-4">
            {data.data.length > 0 ? (
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">{announcement.piattaforma.replace(/_/g, " ")}</p>
                    </div>
              ...
              <div className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed py-12 text-center">
                ...
                <CreateAnnouncementDialog selectionId={selectionId}>
                  <Button className="mt-4 bg-primary text-primary-foreground hover:bg-primary/90 shadow-sm">
                    <PlusCircle />
                    Crea Annuncio
                  </Button>
                </CreateAnnouncementDialog>
